-- -------------------------------------------------------------
-- 
-- File Name: SEL_Reverted\hdlsrc\SEL_test\SEL_toTest_reset_sync.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SEL_toTest_reset_sync
-- Source Path: SEL_toTest/SEL_toTest_reset_sync
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SEL_toTest_reset_sync IS
  PORT( clk_in                            :   IN    std_logic;  -- ufix1
        reset_in                          :   IN    std_logic;  -- ufix1
        reset_out                         :   OUT   std_logic  -- ufix1
        );
END SEL_toTest_reset_sync;


ARCHITECTURE rtl OF SEL_toTest_reset_sync IS
