-- -------------------------------------------------------------
-- 
-- File Name: SEL_Reverted\hdlsrc\SEL_test\SEL_toTest_fifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SEL_toTest_fifo_data
-- Source Path: SEL_toTest/SEL_toTest_axi4_stream_adc1_slave/SEL_toTest_fifo_data
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY SEL_toTest_fifo_data IS
...
END SEL_toTest_fifo_data;


ARCHITECTURE rtl OF SEL_toTest_fifo_data IS
...
BEGIN
  ...
  u_SEL_toTest_fifo_data_classic_ram : SEL_toTest_SimpleDualPortRAM_generic
  ...
  Full_1 <= '1' WHEN Num = to_unsigned(16#4#, 3) ELSE
      '0';
