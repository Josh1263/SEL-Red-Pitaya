-- -------------------------------------------------------------
-- 
-- File Name: SEL_Reverted\hdlsrc\SEL_test\SEL_toTest_src_DitherGen.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: SEL_toTest_src_DitherGen
-- Source Path: SEL_test/TESTBENCH/SEL/SEL_WRAPPED/DSP_LOGIC/DEMUX/NCO/NCO/DitherGen
-- Hierarchy Level: 6
-- Model version: 1.616
-- 
...
ENTITY SEL_toTest_src_DitherGen IS
  PORT( clk                               :   IN    std_logic;
        reset                             :   IN    std_logic;
        validIn                           :   IN    std_logic;
        dither                            :   OUT   std_logic_vector(3 DOWNTO 0)  -- ufix4
        );
END SEL_toTest_src_DitherGen;


ARCHITECTURE rtl OF SEL_toTest_src_DitherGen IS
